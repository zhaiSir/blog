...
<@global.layout pageTitle="必修课"  breadcrumb="<li>培训管理</li><li>必修课</li>"
importJs=["js/training/requiredcourse_list.js"] importCss =["styles/receive.css","styles/tableCommon.css"]>
<section class="main">
    <div class="container-fluid bt-box">
        <form id="requiredCourseForm" class="form-horizontal" action=""
              method="post" name="query-form">

            <div class="wlk-top">
                <div class="row form-qs">
                    <div class="pull-right"   style="white-space: nowrap">
                        <label class="text-right" for="">标题：</label>
                        <input name="courseTitle" class="sm" type="text" Style="width: 120px"
                               value="${requiredCourseQo.courseTitle!}" placeholder="请输入">
                        <label class="text-right" for="">状态：</label>
                        <select name="state" id="state" value="${requiredCourseQo.state!}" class="sm" Style="width: 120px">
                            <option  value=""></option>
                        ...
                        <select name="firstSeries" id="firstSeries" value="${requiredCourseQo.firstSeries!}" class="sm" Style="width: 120px">
                            <option  value=""></option>
                                         <#if firstSeriesList??>
                        ...
                        <select name="secondSeries" id="secondSeries" value="${requiredCourseQo.secondSeries!}" class="sm" Style="width: 120px">
                        </select>
                        <label class="text-right" for="">所属三级专题系列：</label>
                        <select name="thirdSeries" id="thirdSeries" value="${requiredCourseQo.thirdSeries!}" class="sm" Style="width: 120px">
                        </select>
            ...
            <div class="wlk-bottom">
                ...
                <div class="query-operation hide">
                    <button type="button" href="${rc.contextPath}/requiredcourse/add" onclick="addNewOnclick()"
                            class="btn btn-xs btn-add">新增
                    </button>

                    <button type="button" href="${rc.contextPath}/requiredcourse/delete.json"
                ...
                <div class="query-result">
                    <table id="requiredCourseTable" class="bt-table" unique-id="requiredCourseId"
                           url="${rc.contextPath}/requiredcourse/list.json">
                        <thead>
                            <tr class="hide">
                                <th field="checkbox" width="5%" checkbox="true"><input type="checkbox"></th>
                                     <th field="courseTitle">视频标题</th>
                                     <th field="firstSeries">所属一级专题系列</th>
                                     <th field="secondSeries">所属二级专题系列</th>
                                     <th field="thirdSeries">所属三级专题系列</th>
                                     <th field="linkAdress">链接地址</th>
...
<script>
    function operation(value,row,index) {
        ...
        var del =delUpdate == 'stopA'? '<span style="pointer-events: none">删除</span>&nbsp;&nbsp;':'<a href="' + rootPath + '/requiredcourse/delete.json" class="a-confirm" msg="确认删除？">删除</a>&nbsp;&nbsp;';
