...
<@simpleLayout.layout pageTitle="必修课详情" importJs=["js/training/requiredcourse_get.js"] importCss=["styles/addcommon.css"]>
<section class="main">
    <div class="container-fluid user-manage">
        <form id="form-get" class="form-horizontal" action="" method="post">
            <input name="requiredCourseId" id="requiredCourseId" value="${(result.requiredCourseId)!}" type="hidden">
            <div class="form-group">
                <label class="control-label col-sm-4" for="">课件标题：</label>
                <div class="col-sm-18">
                    <input type="text" name="courseTitle" class="form-control" value="${(result.courseTitle)!}" readonly>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-sm-4" for="">链接地址：</label>
                <div class="col-sm-18">
                    <input type="text" name="linkAdress" class="form-control" value="${(result.linkAdress)!}" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4" for="">开始时间：</label>
                <div class="col-sm-18">
                    <input type="text" name="beginTime" class="form-control" value="${(result.beginTime)!}" readonly>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-18">
                    <input type="text" name="description" class="form-control" value="${(result.description)!}" readonly>
                </div>
            </div>
            <div class="form-group">
