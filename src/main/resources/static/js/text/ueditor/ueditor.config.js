...
(function () {
	...
	//UEditor资源与配置路径：URL
	var URL = window.UEDITOR_HOME_URL || contextPath + "/js/text/ueditor/";
	//请求controller路径：dispatchURL
	// 下面alert为测试用 如果不知道路径是什么可以通过alert来测试
	// alert("URL:" + URL);
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
		, serverUrl: contextPath + "/ueditors/dispatch"
        ...
        //rowspacingtop
        //段间距 值和显示的名字相同
        ,'rowspacingtop':['2', '3', '4','5', '10', '15', '20', '25']

        //rowspacingBottom
        //段间距 值和显示的名字相同
        ,'rowspacingbottom':['2', '3', '4', '5', '10', '15', '20', '25']

        //lineheight
        //行内间距 值和显示的名字相同
        ,'lineheight':['0.2','0.3','0.5','0.6','0.7','0.8','0.9','1', '1.5','1.75','2', '3', '4', '5']
